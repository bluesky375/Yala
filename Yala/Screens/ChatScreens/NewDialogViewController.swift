 ...
 class NewDialogViewController: UsersListTableViewController, QMChatServiceDelegate, QMChatConnectionDelegate {
    ...
    class func fromStoryboard() -> NewDialogViewController {
        let viewController = UIStoryboard (name: "Main", bundle: nil).instantiateViewController(withIdentifier: String(describing: NewDialogViewController.self)) as! NewDialogViewController
    ...
    func openNewDialog(dialog: QBChatDialog!) {
        ...
        for vc in navigationArray! {
            ...
            if vc is DialogsViewController {
                let chatVC = ChatViewController.fromStoryboard()
